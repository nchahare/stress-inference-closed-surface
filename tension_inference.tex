...
Refine the IcoSphere from subdiv-3 through subdiv-6 (642, 2562, 10242,
40962 vertices) and plot the relative error against the analytic sphere
solution as a function of mesh spacing $h$.  Expected: roughly second-order
convergence ($\sim h^2$) from the quadratic Taylor fit, confirming the
GFDM operator accuracy.

Also check that the spurious deviatoric (null-mode bias) on the sphere
decreases monotonically with refinement.
